...
SHARED_APPS = [
    ...
    # Test project apps
    'test_django_tenants.companies',
    'test_django_tenants.users',
]
...
ROOT_URLCONF = 'test_django_tenants.test_django_tenants.urls'
...
WSGI_APPLICATION = 'test_django_tenants.wsgi.application'
